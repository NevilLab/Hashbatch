This markdown integrates the different designs within the dataset.
The description of the designs are in the figure 2 of the manuscript.
...
All data are read from the directory ./data and saved at ./SObjects.
