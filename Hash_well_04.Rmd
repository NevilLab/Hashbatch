...
Then it carries out DESeq between samples alpha (baseline) and the rest of the samples (beta, gamma, delta, zeta, epsilon).
...
Load data. These data is not part of the current repository because of their size.
