...
mObject <- RunPCA(mObject, npcs = 30, verbose = FALSE)  
...
```{r}
#features <- SelectIntegrationFeatures(object = hash_well_I, assay = "SCT")
#hash_well_I <- IntegrateLayers(object = hash_well_I, method = CCAIntegration,
#                       orig.reduction = "pca", new.reduction = "integrated.cca",
#                       assay = "SCT", features = features, verbose = FALSE)

hash_well_I <- IntegrateLayers(object = hash_well_I, method = HarmonyIntegration,
                       orig.reduction = "pca", new.reduction = "harmony",
                       assay = "SCT", verbose = FALSE)

hash_well_I <- IntegrateLayers(object = hash_well_I, method = RPCAIntegration,
                       orig.reduction = "pca", new.reduction = "integrated.rpca",
                       assay = "SCT", verbose = FALSE)

#hash_well_I <- IntegrateLayers(object = hash_well_I, method = FastMNNIntegration,
#                       orig.reduction = "pca", new.reduction = "integrated.mnn",
#                       assay = "SCT", verbose = FALSE)

#hash_well_I <- JoinLayers(hash_well_I)
```
